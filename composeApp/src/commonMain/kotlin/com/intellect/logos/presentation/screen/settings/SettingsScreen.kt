...
private fun SettingsContent(
    state: SettingsUDF.State,
    onAction: (SettingsUDF.Action) -> Unit,
        ...
        ExposedDropdownMenu(
            ...
            Theme.entries.forEach { theme ->
                DropdownMenuItem(
                    ...
                    onClick = {
                        isExpanded = false
                        onAction(SettingsUDF.Action.ChangeTheme(theme))
                    }
                )
            }
        }
        ...
        ExposedDropdownMenu(
            ...
            Language.entries.forEach { language ->
                DropdownMenuItem(
                    ...
                    onClick = {
                        isExpanded = false
                        onAction(SettingsUDF.Action.ChangeLanguage(language))
                    }
                )
            }
        }
